...
// Support GS_Panel=1
		...
		{0xB1,10 ,{0x0B, 0x83 ,0x77 ,0x00, 0x0F, 0x0F, 0x17 ,0x17, 0x0C, 0x2A}}, // 0A DC86
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.horizontal_frontporch		      = 90; //132 92 60 60
		params->dsi.horizontal_active_pixel	      = FRAME_WIDTH;
		params->dsi.ssc_disable = 1; // ADD BY PETER
		params->dsi.PLL_CLOCK=215; // 215 235
...
static void lcm_suspend(void)
{
    ...
    SET_RESET_PIN(1);
    MDELAY(20);
    DSI_clk_ULP_mode(1);  //enter ULPM by peter
    MDELAY(100);
	
}

//unsigned int cccwrw=0;
