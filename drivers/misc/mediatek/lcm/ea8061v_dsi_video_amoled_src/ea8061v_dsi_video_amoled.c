...
//    params->dsi.esd_check_enable = 1;   // by zhangxian
...
static void lcm_init_power(void)
{
        ...
        mt_set_gpio_out(GPIO119 | 0x80000000,GPIO_OUT_ZERO);

        mt_set_gpio_mode(GPIO45 | 0x80000000,GPIO_MODE_00);	  
        mt_set_gpio_dir(GPIO45 | 0x80000000,GPIO_DIR_OUT);	  
        mt_set_gpio_out(GPIO45 | 0x80000000,GPIO_OUT_ZERO);
        MDELAY(15); // min 1
        mt_set_gpio_out(GPIO119 | 0x80000000,GPIO_OUT_ONE);
        mt_set_gpio_out(GPIO45 | 0x80000000,GPIO_OUT_ONE);
#if 0
